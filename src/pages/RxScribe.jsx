...
export default function RxScribe() {
  // 🎨 BULLETPROOF THEME CONFIGURATION (Matched exactly to Contact.jsx)
  const theme = {
    colors: {
      background: '#1a0d08',
      accent: '#df7e5a',
  ...
  useEffect(() => {
    document.title = "Rx Scribe | Coming Soon | OneRx";
      ...
      <section style={{ paddingTop: '180px', paddingBottom: '64px' }}>
        <div style={{ ...theme.layout.container, textAlign: 'center', maxWidth: '800px' }}>
          ...
          <p style={{ color: theme.colors.textMuted, fontSize: '1.125rem', lineHeight: '1.7', margin: '0 auto', maxWidth: '600px' }}>
            Clinical documentation, MedsChecks notes, and patient consultations — entirely reimagined for the modern pharmacist.
          </p>
        </div>
      </section>
            ...
            <div style={{ padding: '24px 0' }}>
              <div style={glassCard}>
                ...
                <p style={{ color: theme.colors.textMuted, fontSize: '1rem', lineHeight: '1.7', marginBottom: '32px' }}>
                  We are currently engineering the most seamless clinical documentation tool to ever exist in Canadian pharmacy. Enter your email to join the waitlist and be the first to know when Rx Scribe enters beta testing.
                </p>
