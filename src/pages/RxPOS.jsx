...
export default function RxPOS() {
  ...
  useEffect(() => {
    document.title = "Rx POS | Coming Soon | OneRx";
      ...
      <section style={{ paddingTop: '180px', paddingBottom: '64px' }}>
        <div style={{ ...theme.layout.container, textAlign: 'center', maxWidth: '800px' }}>
          ...
          <p style={{ color: theme.colors.textMuted, fontSize: '1.125rem', lineHeight: '1.7', margin: '0 auto', maxWidth: '600px' }}>
            A point-of-sale system built exclusively for pharmacy. ODB integration, real-time pricing, and seamless DIN management at the till.
          </p>
        </div>
      </section>
            ...
            <div style={{ padding: '24px 0' }}>
              <div style={glassCard}>
                ...
                <p style={{ color: theme.colors.textMuted, fontSize: '1rem', lineHeight: '1.7', marginBottom: '32px' }}>
                  We are building a front-of-house solution that eliminates the double-entry nightmare between the dispensary and the register. Join the waitlist to gain early access.
                </p>
